...
def pdfparser(files, folder_name):
    for file in files:
        file_id = file['id']
        ...
        doc = {
            ...
            "file_added_date": file['createdTime'],  # Add the 'createdTime' as a new field
        }
...
if __name__ == '__main__':
    ...
    #                 pageSize=5))
    files, folder_name = list_drive_files3(service, folder_id,
                                           orderBy='modifiedByMeTime desc',
                                           pageSize=5)
    pdfparser(files, folder_name)
    print("Done")
